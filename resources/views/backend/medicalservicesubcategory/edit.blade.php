    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6">
                        <h4>Edit Medical Service Subcategory</h4>
                    </div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <select name="category_id" id="category_id" class="form-control @error('category_id') is-invalid @enderror" required>
                                            ...
                                            @foreach($categories as $id => $name)
                                                <option value="{{ $id }}" 
                                                    {{ old('category_id', $medicalservicesubcategory->category_id) == $id ? 'selected' : '' }}>
                                                    {{ $name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="subcategory_name" id="subcategory_name" 
                                               ...
                                               value="{{ old('subcategory_name', $medicalservicesubcategory->subcategory_name) }}" 
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control bg-light" value="{{ $medicalservicesubcategory->slug }}" readonly>
