 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="icon" href="{{ asset('admin/assets/images/logo/favicon_bhoj.png') }}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('admin/assets/images/logo/favicon_bhoj.png') }}" type="image/x-icon">
    <title>Somaiya Ayurvihar</title>
    <!-- Google font-->
